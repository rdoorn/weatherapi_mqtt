...
type Current struct {
	...
	AirQuality       *AirQuality `json:"air_quality,omitempty" form:"air_quality,omitempty"`
}
...
type AirQuality struct {
	Co           *float64 `json:"co,omitempty" form:"co,omitempty"`
	No2          *float64 `json:"no2,omitempty" form:"no2,omitempty"`
	O3           *float64 `json:"o3,omitempty" form:"o3,omitempty"`
	So2          *float64 `json:"so2,omitempty" form:"so2,omitempty"`
	Pm2_5        *float64 `json:"pm2_5,omitempty" form:"pm2_5,omitempty"`
	Pm10         *float64 `json:"pm10,omitempty" form:"pm10,omitempty"`
	USEpaIndex   *int     `json:"us-epa-index,omitempty" form:"us-epa-index,omitempty"`
	GBDefraIndex *int     `json:"gb-defra-index,omitempty" form:"gb-defra-index,omitempty"`
}
...
type Astro struct {
	...
	MoonPhase        *string `json:"moon_phase,omitempty" form:"moon_phase,omitempty"`               //Moonset time
	MoonIllumination *string `json:"moon_illumination,omitempty" form:"moon_illumination,omitempty"` //Moonset time
}
